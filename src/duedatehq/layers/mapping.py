...
class ClientRuleMappingService:
    ...
    def register_client(self, tenant_id: str, entity_type: str, registered_states: list[str]) -> Client:
        return self.engine.register_client(tenant_id, entity_type, registered_states)
